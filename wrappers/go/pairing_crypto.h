...
void ffi_support_free_string(char *ptr);
 ...
 */
int32_t bbs_bls12_381_sha_256_generate_key_pair(struct ByteArray ikm,
                                                struct ByteArray key_info,
 ...
 * * key_info: UInt8Array with 32 elements
 */
int32_t bbs_bls12_381_shake_256_generate_key_pair(struct ByteArray ikm,
                                                  struct ByteArray key_info,
                                                  struct ByteBuffer *secret_key,
                                                  struct ByteBuffer *public_key,
                                                  struct ExternError *err);

void bbs_bls12381_sign_free(uint64_t v, struct ExternError *err);

uint64_t bbs_bls12_381_sha_256_sign_context_init(struct ExternError *err);
...
uint64_t bbs_bls12_381_shake_256_sign_context_init(struct ExternError *err);
...
void bbs_bls12381_verify_free(uint64_t v, struct ExternError *err);

uint64_t bbs_bls12_381_sha_256_verify_context_init(struct ExternError *err);
...
int32_t bbs_bls12_381_sha_256_verify_context_finish(uint64_t handle, struct ExternError *err);

uint64_t bbs_bls12_381_shake_256_verify_context_init(struct ExternError *err);
...
int32_t bbs_bls12_381_shake_256_verify_context_finish(uint64_t handle, struct ExternError *err);
...
void bbs_bls12381_derive_proof_free(uint64_t v, struct ExternError *err);

uint64_t bbs_bls12_381_sha_256_proof_gen_context_init(struct ExternError *err);
...
uint64_t bbs_bls12_381_shake_256_proof_gen_context_init(struct ExternError *err);
...
void bbs_bls12381_verify_proof_free(uint64_t v, struct ExternError *err);

uint64_t bbs_bls12_381_sha_256_proof_verify_context_init(struct ExternError *err);
...
int32_t bbs_bls12_381_sha_256_proof_verify_context_finish(uint64_t handle, struct ExternError *err);

uint64_t bbs_bls12_381_shake_256_proof_verify_context_init(struct ExternError *err);
...
int32_t bbs_bls12_381_shake_256_proof_verify_context_finish(uint64_t handle,
                                                            struct ExternError *err);

void pairing_crypto_byte_buffer_free(struct ByteBuffer v);

int32_t pairing_crypto_hwallet_generate_mnemonic(struct ByteBuffer *mnemonic_out,
                                                 struct ExternError *err);

int32_t pairing_crypto_hwallet_mnemonic_to_seed(FfiStr mnemonic,
                                                FfiStr passphrase,
                                                struct ByteBuffer *seed_out,
                                                struct ExternError *err);

int32_t pairing_crypto_hwallet_derive_private_key(struct ByteArray seed,
                                                  FfiStr path,
                                                  struct ByteBuffer *priv_key_out,
                                                  struct ExternError *err);

int32_t pairing_crypto_hwallet_eth_address_from_pubkey(struct ByteArray pubkey,
...
int32_t pairing_crypto_ecies_encrypt(struct ByteArray uncompressed_pubkey,
                                     struct ByteArray msg,
                                     struct ByteBuffer *encrypted_msg_out,
                                     struct ExternError *err);

int32_t pairing_crypto_ecies_decrypt(struct ByteArray privkey_bytes,
